local Keys = {
  ...
  AddEventHandler('esx_gym:useBandage', function()
	  ...
	  ESX.ShowNotification("Has utilizado un ~g~vendaje")
  end)
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(gym) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Presiona ~INPUT_CONTEXT~ para abrir ~b~gym~w~ menu')
			  ...
			  if dist <= 0.5 then
				  ...
				  if IsControlJustPressed(0, Keys['E']) then
					  if training == false then
						  ...
						  ESX.ShowNotification("Preparación ~g~fisica~w~...")
						  Citizen.Wait(1000)					
						  ...
						  if membership == true then
							  ...
							  ESX.ShowNotification("Necesitas un descanso de ~r~60 segundos ~w~antes de hacer otro ejercicio.")
							  
							  --TriggerServerEvent('esx_gym:trainArms') ## COMING SOON...
							  
							  training = true
						  elseif membership == false then
							  ESX.ShowNotification("Debes pagar tu membresia para realizar tus ~r~ejercicios")
						  end
					  elseif training == true then
						  ESX.ShowNotification("Necesitas tomarte un descanso...")
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(chins) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Presiona ~INPUT_CONTEXT~ para realizar ~g~ejercicios')
				  
				  if IsControlJustPressed(0, Keys['E']) then
					  if training == false then
					  
						  TriggerServerEvent('esx_gym:checkChip')
						  ESX.ShowNotification("Preparacion ~g~fisica~w~...")
						  Citizen.Wait(1000)					
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(pushup) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Presiona ~INPUT_CONTEXT~ para hacer algunas ~g~bombas')
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(situps) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Presiona ~INPUT_CONTEXT~ para hacer ~g~ejercicios')
  ...
  function CheckTraining()
	  ...
	  if resting == false then
		  ESX.ShowNotification("Puedes reanudar el ejercicio.")
	  end
  end
	  ...
	  ESX.UI.Menu.Open(
		  ...
		  function(data, menu)
			  ...
			  elseif data.current.value == 'hours' then
				  ...
				  ESX.ShowNotification("Estamos abiertos ~g~24~w~ h/24. Bienvenido!")
  ...
  function OpenGymShopMenu()
	  ...
	  ESX.UI.Menu.Open(
		  'default', GetCurrentResourceName(), 'gym_shop_menu',
		  {
			  title    = 'Gym - Tienda',
			  elements = {
				  {label = 'Batido de proteinas ($50)', value = 'protein_shake'},
				  {label = 'Agua ($10)', value = 'water'},
				  {label = 'Almuerzo deportivo ($45)', value = 'sportlunch'},
				  {label = 'Powerade ($55)', value = 'powerade'},
				  {label = 'Vendajes ($1500)', value = 'bandage'},
			  }
		  },
		  function(data, menu)
  ...
  function OpenGymShipMenu()
	  ...
	  ESX.UI.Menu.Open(
		  ...
		  {
			  title    = 'Gym - Suscripción',
			  elements = {
				  {label = 'Membresia GYM ($800)', value = 'membership'},
			  }
		  },
		  function(data, menu)
