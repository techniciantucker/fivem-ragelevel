Config = {}
	...
	Config.FishPrice = {a = 1000, b = 2000} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 3000, b = 3500} --Will get dirty money
	Config.SharkPrice = {a = 3800, b = 4500} --Will get dirty money
