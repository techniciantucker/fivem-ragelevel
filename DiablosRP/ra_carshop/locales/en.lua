Locales['en'] = {
  ...
  ['car_dealer']              = 'Rolear Vehiculos Importados',
  ['shop_awaiting_model']     = 'se esta cargando el vehiculo',
  ...
  ['set_vehicle_owner_sell']  = 'vender vehiculos',
  ['set_vehicle_owner_sell_society']  = 'assign Vehicle [Sale] [Society]',
  ['shop_menu']               = 'presiona ~INPUT_CONTEXT~ para ver los vehiculos',
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'RoleAR Autos Importados',
  ...
  ['inventory']               = 'inventory',
  ['dealership']              = 'RoleAR Vehiculos Importados',
