...
Config.Zones = {
	...
	VehicleSpawnPoint = {
		Pos   = { x = -1160.42, y = -1711.33, z = 4.15 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -1173.31, y = -1773.0, z = 2.80 },
	...
	VehicleDelivery = {
		Pos   = { x = -1167.925, y = -1738.18, z = 3.6 },
