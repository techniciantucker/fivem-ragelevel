...
local spawnesskey = { x = -1278.39, y = -1386.84, z = 3.38 } --Configuration du point de spawn du faggio
...
[14] ={name ="en un cliente" ,x= -1004.788, y=-1154.824,z = 1.64603},
[15] ={name ="en un cliente" ,x= -1113.937, y=-1193.136,z = 1.827304},
[16] ={name ="en un cliente" ,x= -1075.903, y=-1026.452,z = 4.031562},
[17] ={name ="en un cliente" ,x= -1056.485, y=-1001.234,z = 1.639098},
[18] ={name ="en un cliente" ,x= -1090.886, y=-926.188,z = 2.630009},
[19] ={name ="en un cliente" ,x= -1075.903, y=-1026.452,z = 4.031562},
[20] ={name ="en un cliente" ,x= -1181.652, y=-988.6455,z = 1.634243},
[21] ={name ="en un cliente" ,x= -1151.11, y=-990.905,z = 1.638789},
[22] ={name ="en un cliente" ,x= -1022.788, y=-896.3149,z = 4.908271},
[23] ={name ="en un cliente" ,x= -1060.738, y=-826.829,z = 18.69866},
[24] ={name ="en un cliente" ,x= -968.6487, y=-1329.453,z = 5.144861},
[25] ={name ="en un cliente" ,x= -1185.5, y=-1386.238,z = 4.112149},
[26] ={name ="en un cliente" ,x= -1132.848, y=-1456.029,z = 4.372081},
[27] ={name ="en un cliente" ,x= -1125.602, y=-1544.203,z = 5.391256},
[28] ={name ="en un cliente" ,x= -1084.74, y=-1558.709,z = 4.10145},
[29] ={name ="en un cliente" ,x= -1098.367, y=-1679.272,z = 3.853804},
[30] ={name ="en un cliente" ,x= -1155.863, y=-1574.202,z = 8.344403},
[31] ={name ="en un cliente" ,x= -1122.675, y=-1557.524,z = 5.277201},
[32] ={name ="en un cliente" ,x= -1108.679, y=-1527.393,z = 6.265457},
[33] ={name ="en un cliente" ,x= -1273.549, y=-1382.664,z = 3.81341},
[34] ={name ="en un cliente" ,x= -1342.454, y=-1234.849,z = 5.420023},
[35] ={name ="en un cliente" ,x= -1351.21, y=-1128.669,z = 3.626104},
[36] ={name ="en un cliente" ,x= -1343.232, y=-1043.639,z = 7.303696},
[37] ={name ="en un cliente" ,x= -729.2556, y=-880.1547,z = 22.22747},
[38] ={name ="en un cliente" ,x= -831.3006, y=-864.8558,z = 20.22383},
[39] ={name ="en un cliente" ,x= -810.4093, y=-978.4364,z = 13.74061},
[40] ={name ="en un cliente" ,x= -683.8874, y=-876.8568,z = 24.02004},
[41] ={name ="en un cliente" ,x= -1031.316, y=-903.0217,z = 3.692086},
[42] ={name ="en un cliente" ,x= -1262.703, y=-1123.342,z = 7.092357},
[43] ={name ="en un cliente" ,x= -1225.079, y=-1208.524,z = 7.619214},
[44] ={name ="en un cliente" ,x= -1207.095, y=-1263.851,z = 6.378308},
[45] ={name ="en un cliente" ,x= -1086.787, y=-1278.122,z = 5.09411},
[46] ={name ="en un cliente" ,x= -886.1298, y=-1232.698,z = 5.006698},
[47] ={name ="en un cliente" ,x= -753.5927, y=-1512.016,z = 4.370816},
[48] ={name ="en un cliente" ,x= -696.3545, y=-1386.89,z = 4.846177}
}
  ...
  while true do
    ...
    if isInJobPizz == false then
      ...
      if GetDistanceBetweenCoords(pizzeria.x, pizzeria.y, pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Presione ~INPUT_CONTEXT~ para iniciar la entrega de ~r~pizzas",0,1,0.5,0.8,0.6,255,255,255,255)
    ...
    if isToHouse == true then
      ...
      while notif == true do
        ...
        TriggerEvent("pNotify:SendNotification", {
          text = "Dirección : " ..destinol.. " para entregar la pizza.",
          type = "info",
          queue = "global",
          timeout = 4000,
          layout = "bottomRight"
    ...
    if isToPizzaria == true then
      ...
      if GetDistanceBetweenCoords(pizzeria.x,pizzeria.y,pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 3 and afaitunepizzamin == true then
        HelpText("Presiona ~INPUT_CONTEXT~ para recuperar las pizzas.",0,1,0.5,0.8,0.6,255,255,255,255)

        if IsVehicleModel(GetVehiclePedIsIn(GetPlayerPed(-1), true), GetHashKey("esskey"))  then
          ...
          if IsControlJustPressed(1,38) then
            ...
            if IsInVehicle() then
              ...
              TriggerEvent("pNotify:SendNotification", {
                text = "Le agradecemos su trabajo, aquí está su paga:" .. paie .. "$",
                type = "success",
                queue = "global",
                timeout = 4000,
                layout = "bottomRight"
  ...
  while true do
    ...
    if isInJobPizz == true then
      ...
      if GetDistanceBetweenCoords(pizzeriafin.x, pizzeriafin.y, pizzeriafin.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Presiona ~INPUT_CONTEXT~ para detener la entrega de ~r~pizza",0,1,0.5,0.8,0.6,255,255,255,255)
        ...
        if IsControlJustPressed(1,38) then
          ...
          if afaitunepizzamin == true then
            ...
            TriggerEvent("pNotify:SendNotification", {
              text = "Gracias de todos modos, que tengas un buen día.",
              type = "error",
              queue = "global",
              timeout = 4000,
              layout = "bottomRight"
...
function spawn_esskey() -- Thread spawn faggio

  Citizen.Wait(0)

  local myPed = GetPlayerPed(-1)
  local player = PlayerId()
  local vehicle = GetHashKey('esskey')
  ...
  local spawned_car = CreateVehicle(vehicle, spawnesskey.x,spawnesskey.y,spawnesskey.z, 431.436, - 996.786, 25.1887, true, false)
