...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -1168.48, y = -1725.55, z = 4.982},
	...
	ls2 = {
		Pos   = { x = -1178.78, y = -1710.88, z = 4.52},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = -1174.94, y = -1730.77, z = 4.52},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = -1191.19, y = -1718.83, z = 4.52},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = -1180.86, y = -1736.03, z = 4.51},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = -1154.69, y = -1694.15, z = 4.45},
	...
	ls7 = {
		Pos   = { x = -1185.31, y = -1714.88, z = 4.52},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
