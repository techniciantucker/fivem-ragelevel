...
Config.Strings = {
	ExitVehicle = "Sal del vehiculo para llenar",
	EToRefuel = "Presione ~g~E ~w~para llenar el vehiculo",
	JerryCanEmpty = "Jerry can is empty",
	FullTank = "Tanque lleno",
	PurchaseJerryCan = "Presiona ~g~E ~w~para comprar bidón ~g~$" .. Config.JerryCanCost,
	...
	NotEnoughCashJerryCan = "No tienes suficiente dinero para refenar el bidón ",
	JerryCanFull = "Tu bidón esta lleno"
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para comprar bidón"
