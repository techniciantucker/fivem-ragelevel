...
ESX.Game.GetVehicleProperties = function(vehicle)
	...
	return {
		...
		HeadlightsColour  = table.pack(GetVehicleHeadlightsColour(vehicle)),
...
ESX.Game.SetVehicleProperties = function(vehicle, props)
	...
	if props.HeadlightsColour ~= nil then
        SetVehicleHeadlightsColour(vehicle, props.HeadlightsColour[1], props.HeadlightsColour[2], props.HeadlightsColour[3])
    end
