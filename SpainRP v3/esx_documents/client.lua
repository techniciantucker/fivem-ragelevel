...
local MENU_OPTIONS = {
    ...
    menu_subtitle = "Opciones de Documentos",
    color_r = 0,
    color_g = 128,
    color_b = 255,
}
...
function OpenMainMenu()
    ...
    Menu.addButton("Documentos con Trabajos", "OpenNewJobFormMenu", nil)
    Menu.addButton("Documentos Guardados", "OpenMyDocumentsMenu", nil)
...
function ShowToNearestPlayers(aDocument)
    ...
    if #players_clean > 0 then
        ...
        Menu.addButton("No se ha encontrado jugadores cerca", "CloseMenu", nil)
    end
...
function CopyToNearestPlayers(aDocument)
    ...
    Menu.addButton("Volver atras", "OpenFormPropertiesMenu", aDocument)
    Menu.addButton("Cerrar", "CloseMenu", nil)
end
...
function OpenFormPropertiesMenu(aDocument)
    ClearMenu()
    Menu.addButton("Ver", "ViewDocument", aDocument.data)
    Menu.addButton("Monstrar", "ShowToNearestPlayers", aDocument.data)
    Menu.addButton("Dar una copia", "CopyToNearestPlayers", aDocument.data)
    Menu.addButton("Eliminar", "OpenDeleteFormMenu", aDocument)
    Menu.addButton("Volver atras", "OpenMyDocumentsMenu", nil)
    Menu.addButton("Cerrar Menu", "CloseMenu", nil)
    Menu.hidden = false
end
...
function OpenDeleteFormMenu(aDocument)
    ClearMenu()
    Menu.addButton("Si, eliminar", "DeleteDocument", aDocument)
    Menu.addButton("Volver Atras", "OpenFormPropertiesMenu", aDocument)
    Menu.addButton("Cerrar", "CloseMenu", nil)
    Menu.hidden = false
end
