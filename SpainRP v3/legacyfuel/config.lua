...
Config.Strings = {
	...
	JerryCanEmpty = "La lata de gasolina esta vacia",
	FullTank = "Tanque lleno",
	PurchaseJerryCan = "Presiona ~g~E ~w~para comprar una lata de gasolina por ~g~" .. Config.JerryCanCost .. " €",
	CancelFuelingPump = "Presiona ~g~E ~w~para parar de respostar",
	CancelFuelingJerryCan = "Presiona ~g~E ~w~para parar de repostar",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Presiona ~g~E ~w~ para rellenar la lata de gasolina ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero para rellenar la lata",
	JerryCanFull = "La lata de gasolina esta llena",
	TotalCost = "Precio",
}
