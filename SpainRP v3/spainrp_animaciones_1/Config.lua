...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/APGfD8W.png",
...
Config.Languages = {
  ...
  ['es'] = {
        ...
        ['infoupdateav'] = "SpainRP",
        ['infoupdateavtext'] = "SpainRP.es",
        ['suggestions'] = "Foro",
        ['suggestionsinfo'] = "foro.spainrp.es ✉️",
        ['notvaliddance'] = "No es un baile valido.",
        ['notvalidemote'] = "No es una animacion valida.",
        ['nocancel'] = "No hay animacion para cancelar.",
        ['maleonly'] = "Esta animacion es solo para hombre!",
        ...
        ['keybinds'] = "🔢 Teclas de acceso directo",
