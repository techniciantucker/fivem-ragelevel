...
Citizen.CreateThread(function ()
  while true do
    ...
    local trabajo = PlayerData.job.name

    for k,v in pairs(Config.Zones) do
      if trabajo == 'police' or trabajo == 'ambulance' or trabajo == 'mechanic' or trabajo == 'taxi' or trabajo == 'mecaniconorte' or trabajo == 'offpolice' or trabajo == 'offambulance' or trabajo == 'offmechanic' or trabajo == 'offtaxi' or trabajo == 'offmecaniconorte' then
