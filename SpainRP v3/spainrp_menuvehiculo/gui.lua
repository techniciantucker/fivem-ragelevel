...
function Menu:setTitle(options)
	...
	DrawRect(options.x,(options.y + 0.01),options.width,(options.height + 0.08),options.color_r + 0,options.color_g + 113,options.color_b + 206,255)
	DrawText(options.x, options.y - 0.01)
end
...
function Menu:setSubTitle(options)
	...
	SetTextColour(97, 162, 194, 255)
	SetTextEntry("STRING")
	AddTextComponentString(options.menu_subtitle)
	DrawRect(options.x,(options.y +0.08),options.width,options.height,(options.color_r + 0),(options.color_g + 0),(options.color_b + 0),255)
	DrawText(options.x - options.width/2 + 0.005, (options.y + 0.085) - options.height/2 + 0.0028)
...
function Menu:drawButtons(options)
	...
	for id, settings in pairs(Menu.GUI) do
		...
		DrawText(options.x - options.width/2 + 0.005, y - 0.03/2 + 0.0028)
		y = y + 0.0333
	end
end
