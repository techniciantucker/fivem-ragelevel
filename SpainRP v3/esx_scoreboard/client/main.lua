...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, mecaniconorte, estate, players = 0, 0, 0, 0, 0, 0, 0
	...
	for k,v in pairs(connectedPlayers) do
		...
		elseif v.job == 'taxi' then
			taxi = taxi + 1
		elseif v.job == 'mechanic' or v.job == 'mecaniconorte' then
			mechanic = mechanic + 1
		end
	end
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, mecaniconorte = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
end
