...
local buttonHeight = 0.0333
local buttonFont = 0
local buttonScale = 0.300
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].subTitle = 'MENÚ DE ACCIONES'
	...
	menus[id].titleBackgroundColor = { r = 4, g = 170, b = 106, a = 255 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuSubTextColor = { r = 10, g = 189, b = 189, a = 255 }
