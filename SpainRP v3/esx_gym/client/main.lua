local Keys = {
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(gym) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Pulsa ~INPUT_CONTEXT~ para abrir el menu del ~b~gimnasio~w~')
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(arms) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Pulsa ~INPUT_CONTEXT~ para ejercitar tus ~g~brazos')
				  ...
				  if IsControlJustPressed(0, Keys['E']) then
					  if training == false then
						  ...
						  if membership == true then
							  ...
							  TriggerServerEvent('esx_gym:removeStress')
							  Citizen.Wait(30000)
							  ClearPedTasksImmediately(playerPed)
							  ESX.ShowNotification("Debes esperar ~r~60 segundos ~w~antes de hacer otro ejercicio.")
							  
							  --TriggerServerEvent('esx_gym:trainArms') ## COMING SOON...
							  
							  training = true
						  elseif membership == false then
							  ESX.ShowNotification("Necesitas el carnet del gimnasio para poder hacer ~r~ejercicio")
						  end
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(chins) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Pulsa ~INPUT_CONTEXT~ para hacer ~g~dominadas')
				  ...
				  if IsControlJustPressed(0, Keys['E']) then
					  if training == false then
						  ...
						  if membership == true then
							  ...
							  training = true
						  elseif membership == false then
							  ESX.ShowNotification("Necesitas una membresia para poder hacer ~r~ejercicio")
						  end
					  elseif training == true then
						  ESX.ShowNotification("Necesitas descansar...")
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  for k in pairs(pushup) do
			  ...
			  if dist <= 0.5 then
				  hintToDisplay('Pulsa ~INPUT_CONTEXT~ para hacer unas ~g~planchas')
  ...
  function CheckTraining()
	  ...
	  if resting == false then
		  ESX.ShowNotification("Puedes hacer ejercicio de nuevo...")
	  end
  end
...
function OpenGymMenu()
	  ...
	  ESX.UI.Menu.Open(
		  'default', GetCurrentResourceName(), 'gym_menu',
		  {
			  ...
			  elements = {
				  ...
				  {label = 'Carnet del gimnasio', value = 'ship'},
			  }
		  },
		  function(data, menu)
  ...
  function OpenGymShipMenu()
	  ...
	  ESX.UI.Menu.Open(
		  ...
		  {
			  title    = 'Gym - Carnet del gimnasio',
			  align    = 'bottom-right',
			  elements = {
				  {label = 'Carnet del gimnasio (800€)', value = 'membership'},
			  }
		  },
		  function(data, menu)
