        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) and IsJobTrucker() then -- Touche E
                ...
                if CurrentAction == 'vehicledeleter' then
					...
					if plate == matriculaactual then
                	TriggerServerEvent('gopostal_job:caution', "give_back", giveBack)
					ESX.Game.DeleteVehicle(CurrentActionData.vehicle)
					else
					ESX.ShowNotification('Ese no es el vehiculo que te hemos dado')
					end
					end
                end
...
Citizen.CreateThread(function()
		local blip = AddBlipForCoord(Config.Zones.Distribution.Pos.x, Config.Zones.Distribution.Pos.y, Config.Zones.Distribution.Pos.z)
		...
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString('Centro de distribucion')
		EndTextCommandSetBlipName(blip)
	end
end)
