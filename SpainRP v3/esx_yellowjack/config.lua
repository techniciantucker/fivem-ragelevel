...
Config.Blips = {
    ...
    Blip = {
      Pos     = { x = 1990.00, y = 3052.00, z = 50.00 },
      Sprite  = 103,
      Display = 4,
      Scale   = 1.0,
      Colour  = 27,
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x = 1993.89, y = 3050.44, z = 46.22 },
    ...
    Vaults = {
        Pos   = { x = 1997.24, y = 3038.93, z = 46.03 },
        Size  = { x = 1.2, y = 1.2, z = 1.2 },
        Color = { r = 153, g = 255, b = 51 },
        Type  = 1,
    },

    Fridge = {
        Pos   = { x = 1985.36, y = 3048.94, z = 46.22 },
        Size  = { x = 1.2, y = 1.2, z = 1.2 },
...
--[[
    ...
    BossActions = {
        Pos   = { x = 1994.37, y = 3046.81, z = 46.22 },
        Size  = { x = 1.2, y = 1.2, z = 1.2 },
        Color = { r = 255, g = 0, b = 0 },
        Type  = 1,
    },
...
----- TELEPORTERS -----
 ...
 Config.TeleportZones = {
  --[[EnterBuilding = {
    Pos       = { x = -1391.88, y = -597.49, z = 29.32 },
    Size      = { x = 1.2, y = 1.2, z = 1.2 },
    Color     = { r = 100, g = 0, b = 255 },
    Marker    = 1,
    Hint      = _U('e_to_enter_1'),
    Teleport  = { x = -1390.71, y = -600.57, z = 29.32 }
  },

  ExitBuilding = {
    Pos       = { x = -1390.71, y = -600.57, z = 29.32 },
    Size      = { x = 1.2, y = 1.2, z = 1.2 },
    Color     = { r = 100, g = 0, b = 255 },
    Marker    = 1,
    Hint      = _U('e_to_exit_1'),
    Teleport  = { x = -1391.88, y = -597.49, z = 29.32 },
  },

  EnterBuilding2 = {
    Pos       = { x = -1382.21, y = -632.36, z = 29.82 },
    Size      = { x = 1.2, y = 1.2, z = 1.2 },
    Color     = { r = 100, g = 0, b = 255 },
    Marker    = 1,
    Hint      = _U('e_to_enter_2'),
    Teleport  = { x = -1379.38, y = -630.88, z = 29.82 }
  },

  ExitBuilding2 = {
    Pos  = { x = -1379.38, y = -630.88, z = 29.82 },
    Size      = { x = 1.2, y = 1.2, z = 1.2 },
    Color     = { r = 100, g = 0, b = 255 },
    Marker    = 1,
    Hint      = _U('e_to_exit_2'),
    Teleport  = { x = -1382.21, y = -632.36, z = 29.82 },
  }, ]]
