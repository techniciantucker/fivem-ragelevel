...
Config.SellHeroine = true	-- if true, players can sell opium
Config.WeedPrice = 22	-- sell price for single, not pooch (black money)
...
Config.HeroinePrice = 50	-- sell price for single, not pooch (black money)
Config.DistanceFromCity = 3000 -- set distance that player cant sell drugs too far from city
Config.CityPoint = {x= -111.98, y= -905.44, z= 29.18}
