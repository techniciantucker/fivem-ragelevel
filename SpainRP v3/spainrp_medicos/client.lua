...
AddEventHandler('esx:onPlayerDeath', function(data)
	...
	if (bone == 31086) then
		multi = 0.0
		-- print('HEADSHOT')
		TriggerEvent('chatMessage', "Enfermera", {255, 0, 0}, "Te han disparado en la cabeza.")
		bleeding = 5
		area = "Cabeza"
	end
	if bone == 24817 or bone == 24818 or bone == 10706 or bone == 24816 or bone == 11816 then
		multi = 1.0
		-- print('BODYSHOT')
		TriggerEvent('chatMessage', "Enfermera", {255, 0, 0}, "Te han disparado en el cuerpo")
		bleeding = 2
		area = "Cuerpo"
	end
...
local md = Config.Declared
	...
	-- 	message = nameF..' '..nameL..' '..Config.Declared
        ...
        --     template = '<div class="chat-message ems"><b>Centro Medico </b>: <b>'..message..'</b></div>',
        --     args = { -1, message }
        -- })
