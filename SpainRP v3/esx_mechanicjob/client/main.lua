...
function StopNPCJob(cancel)
	...
	if cancel then
		...
		--TriggerServerEvent('esx_srpmechanic:onNPCJobCompleted')
	end
end
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_harvest', {
			...
			if data.current.value == 'gaz_bottle' then
				TriggerServerEvent('esx_srpmechanic:startHarvest')
			elseif data.current.value == 'fix_tool' then
				TriggerServerEvent('esx_srpmechanic:startHarvest2')
			elseif data.current.value == 'caro_tool' then
				TriggerServerEvent('esx_srpmechanic:startHarvest3')
			end
		end, function(data, menu)
			menu.close()
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_craft', {
			...
			if data.current.value == 'blow_pipe' then
				TriggerServerEvent('esx_srpmechanic:startCraft')
			elseif data.current.value == 'fix_kit' then
				TriggerServerEvent('esx_srpmechanic:startCraft2')
			elseif data.current.value == 'caro_kit' then
				TriggerServerEvent('esx_srpmechanic:startCraft3')
			end
		end, function(data, menu)
			menu.close()
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						menu.close()
						TriggerServerEvent('esx_srpfacturas:sendBill', GetPlayerServerId(closestPlayer), 'society_mechanic', _U('mechanic'), amount)
					end
				end
			end, function(data, menu)
				menu.close()
					...
					if NPCOnJob then
						if NPCTargetDeleterZone then
							...
							if CurrentlyTowedVehicle == NPCTargetTowable then
								...
								TriggerServerEvent('esx_srpmechanic:onNPCJobMissionCompleted')
								StopNPCJob()
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_srpmechanic:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_srpmechanic:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_srpmechanic:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_srpmechanic:putStockItems', itemName, count)
...
RegisterNetEvent('esx_srpmechanic:onHijack')
AddEventHandler('esx_srpmechanic:onHijack', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_srpmechanic:onCarokit')
AddEventHandler('esx_srpmechanic:onCarokit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_srpmechanic:onFixkit')
AddEventHandler('esx_srpmechanic:onFixkit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('esx_srpmechanic:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_srpmechanic:hasExitedMarker', function(zone)
	if zone =='VehicleDelivery' then
		NPCTargetDeleterZone = false
	elseif zone == 'Craft' then
		TriggerServerEvent('esx_srpmechanic:stopCraft')
		TriggerServerEvent('esx_srpmechanic:stopCraft2')
		TriggerServerEvent('esx_srpmechanic:stopCraft3')
	elseif zone == 'Garage' then
		TriggerServerEvent('esx_srpmechanic:stopHarvest')
		TriggerServerEvent('esx_srpmechanic:stopHarvest2')
		TriggerServerEvent('esx_srpmechanic:stopHarvest3')
	end
...
AddEventHandler('esx_srpmechanic:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()
...
AddEventHandler('esx_srpmechanic:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('esx_srpmechanic:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('esx_srpmechanic:hasExitedMarker', LastZone)
			end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('esx_srpmechanic:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity then
				TriggerEvent('esx_srpmechanic:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
	end
