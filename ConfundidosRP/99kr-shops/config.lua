Config = {
    ...
    Locations = {
        ...
        [14] = {
            ["shelfs"] = {
                {["x"] = 255.75, ["y"] = -782.35, ["z"] = 30.54, ["value"] = "checkout"},
                {["x"] = 261.34, ["y"] = -777.74, ["z"] = 30.6, ["value"] = "drinks"},
                {["x"] = 258.58, ["y"] = -778.55, ["z"] = 30.59, ["value"] = "snacks"},
                {["x"] = 548.08, ["y"] = 2669.36, ["z"] = 42.16, ["value"] = "diverse"},
            },
            ["blip"] = {
                ["x"] = 255.75, ["y"] = -782.35, ["z"] = 30.54
            },
            ["cashier"] = {
                ["x"] = 252225.09, ["y"] = -783.8, ["z"] = 30.51, ["h"] = 310.32
            },
        },
    ...
    Locales = {
        ...
        ["drinks"] = "Bebidas",
        ["snacks"] = "Snacks",
        ["readymeal"] = "Comida rápida",
        ["diverse"] = "Diversos",
    },

    Items = {
        ["drinks"] = {
           -- {label = "Monster", item = "monster", price = 20},
            {label = "Agua", item = "water", price = 1},
            {label = "Monster Energy", item = "energy", price = 3},
            {label = "Limonada", item = "limonade", price = 2},
            {label = "CocaCola", item = "cocacola", price = 4},
            {label = "Té", item = "icetea", price = 5},
            {label = "Café", item = "coffee", price = 2},
            {label = "Zumo de frutas", item = "jusfruit", price = 2},
            {label = "Cola", item = "soda", price = 2},
        },
        ["snacks"] = {
            {label = "Pan", item = "bread", price = 1},
            {label = "Rollitos", item = "rollitos", price = 3},
            {label = "Anacardos", item = "bolnoixcajou", price = 4},
            {label = "Lays", item = "bolchips", price = 2},
            {label = "Pistachos", item = "bolpistache", price = 8},
            {label = "Hamburguesa", item = "burger", price = 4},
            {label = "Cacahuetes", item = "bolcacahuetes", price = 5},
            {label = "Chucherias", item = "croquettes", price = 20},
        },
        ...
        ["diverse"] = {
            {label = "Kit de reparación", item = "fixkit", price = 1500},
        },
    },
}
