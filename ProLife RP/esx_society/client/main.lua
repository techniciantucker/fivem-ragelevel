...
function OpenRecruitMenu(society)
	...
	ESX.TriggerServerCallback('esx_society:getOnltoniinePlayers', function(players)
...
AddEventHandler('esx_society:openBostonisMenu', function(society, close, options)
	Citizen.Trace("hola")
