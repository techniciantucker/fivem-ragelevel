...
local npcs = {
	...
	z = 31.72,
	rotation = -40.0,
	msg = "[Teniente Zoiki] Pulsa E para hablar con él.", 
	r = 255,
	g = 242,
	b = 0,
	model = 'G_M_Y_Lost_03'}
...
AddEventHandler('playerSpawned', function(spawn)
	TriggerServerEvent('advisercomisaria:getElements')
end)
TriggerServerEvent('advisercomisaria:getElements')
...
Citizen.CreateThread(function()
	for i,v in pairs(npcs) do
		Citizen.Trace(0)
		wanted_model= "s_m_m_fiboffice_02"
...
function createNPCA()
	for i,v in pairs(npcs) do
		created_ped = CreatePed(5, GetHashKey('s_m_m_fiboffice_02') , v.x,v.y,v.z - 1, v.rotation, false, true)
...
function OpenMenu()
	ESX.UI.Menu.Open(
		...
		{
			title  = "Información Guardia Civil",
			align    = 'bottom-right',
			elements = elements
		},
		function(data, menu)
