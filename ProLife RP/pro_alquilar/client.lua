...
------------------------------------------------------------------------------------------------------------------
---CREADO POR: Kaprix, está prohibida la distrubición y venta de este script, en caso de venta serás reportado.---
------------------------------------------------------------------------------------------------------------------
...
function OpenBikesMenu()
	...
	if Config.EnablePrice == true then
		table.insert(elements, {label = _U('seashark'), value = 'seashark'}) 
	end
