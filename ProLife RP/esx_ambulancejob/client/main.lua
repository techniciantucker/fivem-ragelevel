  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBostonisMenu', 'ambulance', function(data, menu)
          menu.close()
        end, {wash = false})
      end
		...
		if data.current.value == 'citizen_interaction' then
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if data.current.value == 'revive' then -- revive
                  ...
                  TriggerServerEvent('esx_ambulancejob:retonivive', GetPlayerServerId(closestPlayer))
                  TriggerServerEvent('exp:addExperience',15)
									IsBusy = false
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        {label = 'Uniforme desnudo', value = 'desnudo'},
        {label = ''},
        {label = '-= Uniformidades básicas =-'},
        {label = 'Uniforme básico', value = 'base'},
        {label = 'Pantalón 1', value = 'pantalon1'},
        {label = 'Pantalón 2', value = 'pantalon2'},
        {label = ''},
        {label = '-= Añadir chaleco =-'},
        {label = 'Chaleco de Enfermero', value = 'enfermero'},
        {label = 'Chaleco de Técnico', value = 'tecnico'},
        {label = 'Chaleco de Médico', value = 'medico'},
        {label = 'Chaleco de Forense', value = 'forense'},
        {label = 'Chaleco de Doctor', value = 'doctor'},
        {label = 'Chaleco de Jefatura', value = 'jefatura'},
        {label = ''},
        {label = '-= Añadir accesorios =-'},
        {label = 'Añadir guantes' , value = 'conguantes'},
        {label = 'Añadir estetoscopio' , value = 'conestetoscopio'},
        {label = '-= Quitar accesorios =-'},
        {label = 'Quitar chaleco' , value = 'quitarchaleco'},
        {label = 'Quitar guantes' , value = 'singuantes'},
        {label = 'Quitar estetoscopio' , value = 'sinestetoscopio'},
      },
    },
    function(data, menu)
      ...
      if data.current.value == 'desnudo' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          ...
          if skin.sex == 0 then
            TriggerEvent('skinchanger:change', 'tshirt_1', 13)
            TriggerEvent('skinchanger:change', 'tshirt_2', 0)
            TriggerEvent('skinchanger:change', 'torso_1', 13)
      ...
      if data.current.value == 'enfermero' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'tecnico' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'medico' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'forense' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'doctor' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'jefatura' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
...
RegisterNetEvent('esx_ambulancejob:retonivive')
AddEventHandler('esx_ambulancejob:retonivive', function()
      ...
      if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' then
        ...
        if CurrentAction == 'delete_vehicle' then
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicletoniInGarage', 'ambulance', vehicleProps)
          end
