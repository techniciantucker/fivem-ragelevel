...
local pizzeria = { x = -300.2, y = 6256.32, z = 29.85}
local spawnfaggio = { x = -295.48, y = 6253.24, z = 31.44 }

local propina = 0
local posibilidad = 0

local casas = {
	[4] = {name = "Procopio Promenade / Paleto Forest",x = -682.08, y = 5770.76 , z = 16.52},
	[5] = {name = "Procopio Promenade / Paleto Forest",x = -709.8, y = 5768.96 , z = 16.52},
	[6] = {name = "Procopio Promenade / Paleto Bay",x = -453.12, y = 6336.84 , z = 12.12},
	[7] = {name = "Paleto Bay" ,x =-437.76,y =6272.4,z =29.08},
	[8] = {name = "Paleto Bay" ,x =-359.2,y =6334.12,z =28.84},
	[9] = {name = "Paleto Bay" ,x = -272.12,y =6400.28,z =30.36},
	[10] = {name = "Paleto Bay" ,x = -41.4,y =6637.04,z =30.08},
	[11] = {name = "Paleto Bay" ,x = -453.56,y =6337.48,z =11.8},
	[12] = {name = "Paleto Bay" ,x = -481.92,y =6276.48,z =12.4},
	[13] = {name = "Paleto Bay" ,x = -119.96,y =6326.92,z =33.52},
	[14] = {name = "Paleto Bay" ,x = -102.2,y =6344.88,z =30.56},
	[15] = {name = "Paleto Bay" ,x = -89.68,y =6356.48,z =30.56},
	[16] = {name = "Paleto Bay" ,x = -90.2,y =6357.0,z =34.52},
	[17] = {name = "Paleto Bay" ,x = -38.36,y =6419.72,z =30.48},
	[18] = {name = "Paleto Bay" ,x = 1510.32,y =6326.08,z =23.6},
}
...
local blips = {
	{title="Pizzeria", colour=66, id=267, x = -300.2, y = 6256.32, z = 30.52},
}
