...
local npcs = {
	...
	z = 31.5,
	rotation = -150.0,
	msg = "[Pablo Escobar] Pulsa E para crear una banda",
	r = 255,
	g = 0,
	b = 0,
	model = 'G_M_Y_Lost_03'}
...
Citizen.CreateThread(function()
	for i,v in pairs(npcs) do
		Citizen.Trace(0)
		wanted_model= "u_m_y_prisoner_01"
...
function createNPCA()
	for i,v in pairs(npcs) do
		created_ped = CreatePed(5, GetHashKey('u_m_y_prisoner_01') , v.x,v.y,v.z - 1, v.rotation, false, true)
