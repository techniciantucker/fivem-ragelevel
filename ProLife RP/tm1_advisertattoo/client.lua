...
local npcs = {
	...
	z = 31.49,
	rotation = -150.0,
	msg = "[Tatuador] Pulsa E para hacerte un tatuaje.",
	r = 255,
	g = 242,
	b = 0,
	model = 'G_M_Y_Lost_03'}
...
function createNPCA()
	for i,v in pairs(npcs) do
		created_ped = CreatePed(5, GetHashKey('u_m_y_tattoo_01') , v.x,v.y,v.z - 1, v.rotation, false, true)
