...
Config.TimerBeforeNewRob    = 1080 -- The cooldown timer on a store after robbery was completed / canceled, in seconds
...
Stores = {
	...
	["littleseoul_twentyfourseven"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "24/7. (Hermanas Manitas)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	},
	["bar_one"] = {
	...
	["ocean_liquor"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "Robo de Licoreria. (Great Ocean)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	},
	["rancho_liquor"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "Robo de Licoreria. (El Rancho Blvd)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	},
	["sanandreas_liquor"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "Robo de Licoreria. (Avenida San Andreas)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	},
	["grove_ltd"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "Gasolinera. (Grove Street)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	},
	["mirror_ltd"] = {
		...
		reward = math.random(30000, 35000),
		nameOfStore = "Gasolinera. (Mirror Park Boulevard)",
		secondsRemaining = 200, -- seconds
		lastRobbed = 0
	}
}
