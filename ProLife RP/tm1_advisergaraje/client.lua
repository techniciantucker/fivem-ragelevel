...
local npcs = {
	...
	z = 31.5,
	rotation = -210.0,
	msg = "[Chacho] Pulsa E para sacar tu vehículo.",
	r = 0,
	g = 255,
	b = 38,
	model = 'G_M_Y_Lost_03'}
...
Citizen.CreateThread(function()
	for i,v in pairs(npcs) do
		Citizen.Trace(0)
		wanted_model= "s_m_m_security_01"
...
function createNPCA()
	for i,v in pairs(npcs) do
		created_ped = CreatePed(5, GetHashKey('s_m_m_security_01') , v.x,v.y,v.z - 1, v.rotation, false, true)
