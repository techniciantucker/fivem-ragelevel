...
AddTextEntry(controllerMessageLoweredCar, "Presiona ~INPUT_CONTEXT~ para ~y~subir ~w~la plataforma.~n~Presiona ~INPUT_DETONATE~ para ~r~desenganchar ~w~el vehiculo.")
AddTextEntry(controllerMessageLoweredNoCar, "Presiona ~INPUT_CONTEXT~ para ~y~subir ~w~la plataforma.~n~Presiona ~INPUT_DETONATE~ para ~g~enganchar ~w~el vehiculo.")
AddTextEntry(controllerMessageRaised, "Presiona ~INPUT_CONTEXT~ para ~y~bajar ~w~la plataforma.")
