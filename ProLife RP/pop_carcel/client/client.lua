...
RegisterNetEvent("esx-qalle-jail:jailPtonilayer")
AddEventHandler("esx-qalle-jail:jailPtonilayer", function(newJailTime)
	jailTime = newJailTime
						...
						function(data3, menu3)
						  	...
						  	if reason == nil then
								...
								if closestPlayer == -1 or closestDistance > 3.0 then
								  	...
								  	TriggerServerEvent("esx-qalle-jail:jailPtonilayer", GetPlayerServerId(closestPlayer), jailTime, reason)
								end
