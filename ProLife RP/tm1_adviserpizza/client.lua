...
local npcs = {
	...
	z = 31.5,
	rotation = -150.0,
	msg = "[Paco] Pulsa E para trabajar de pizzero.",
	r = 255,
	g = 242,
	b = 0,
	model = 'G_M_Y_Lost_03'}
...
function createNPCA()
	for i,v in pairs(npcs) do
		created_ped = CreatePed(5, GetHashKey('csb_burgerdrug') , v.x,v.y,v.z - 1, v.rotation, false, true)
