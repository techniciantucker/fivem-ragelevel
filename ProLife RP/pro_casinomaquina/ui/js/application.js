      ...
      setTimeout(function(){
       // coin_sound.currentTime = 0;
        ...
        if (game_state.win == game_state.paid) {
		  $.post('http://pro_casinomaquina/payforplayer', JSON.stringify(game_state.win));
...
function post(name, data) {
    $.post('http://pro_casinomaquina/'+name, JSON.stringify(data));
}
...
$.post('http://pro_casinomaquina/playerpays', JSON.stringify(playerbet));
