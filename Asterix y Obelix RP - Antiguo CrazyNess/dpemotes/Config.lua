...
Config.Languages = {
  ['en'] = {
        ...
        ['cancelemoteinfo'] = "~r~X~w~ Cancela la animacion",
        ['walkingstyles'] = "Estilos de Andar",
        ...
        ['shareemotes'] = "👫 Animaciones Sincronizadas",
        ['shareemotesinfo'] = "Invitas a otro a una animacion sincronizada",
        ['sharedanceemotes'] = "🕺 Bailes",
        ['notvalidsharedemote'] = "is not a valid shared emote.",
        ['sentrequestto'] = "Sent request to ~y~",
        ['nobodyclose'] = "Nadie ~r~Cerca~w~.",
        ['doyouwanna'] = "~y~Y~w~ Aceptar, ~r~L~w~ Rechazar (~g~",
        ['refuseemote'] = "Emote refused.",
        ['makenearby'] = "Animacion con otra persona",
        ['camera'] = "Presiona ~y~K~w~ para usar flash.",
        ['makeitrain'] = "Presiona ~y~K~w~ para tirar dinero.",
        ['pee'] = "Hold ~y~G~w~ to pee.",
        ['spraychamp'] = "Manten ~y~K~w~ para tirar champan",
        ['bound'] = "Bound ",
        ['to'] = "to",
