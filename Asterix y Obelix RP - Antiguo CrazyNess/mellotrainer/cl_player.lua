...
RegisterNUICallback("player", function(data, cb)
	...
	if action == "heal" then
		...
		TriggerServerEvent('mello:logToadmin', plrname .. " cleaned and healed themselfs", "PLY", "PLAYER")
	...
	elseif action == "armor" then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " added armour to themselfs", "PLY", "PLAYER")
	...
	elseif action == "god" then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " set godmode to " .. tostring(text), "PLY", "PLAYER")
	...
	elseif action == "stamina" then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " set unlimited stamina to " .. tostring(text), "PLY", "PLAYER")
	...
	elseif action == "invisible" then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " set invisibility to " .. tostring(text), "PLY", "PLAYER")
