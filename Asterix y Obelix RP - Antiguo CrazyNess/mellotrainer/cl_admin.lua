...
AddEventHandler("debug:queueCount", function(qCount)
	queueCount = qCount
end)

RegisterNUICallback("queueCount", function(data, cb)
	drawNotification("Current Queue Count: " .. queueCount)
	cb("ok")
end)

RegisterNUICallback("storageCrate", function(data, cb)
	TriggerEvent("debug:showCrateID")
	drawNotification("Now showing IDs of Storage Crates")
	cb("ok")
end)
