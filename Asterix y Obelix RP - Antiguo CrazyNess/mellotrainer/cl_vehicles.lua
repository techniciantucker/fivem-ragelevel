...
RegisterNUICallback("veh", function(data, cb)
	...
	elseif action == "fixset"then
		...
		TriggerServerEvent('mello:logToadmin', plrname .. " used fix and set", "VEH", "VEHICLE")
...
RegisterNUICallback("vehopts", function(data, cb)
	...
	elseif(action == "powerboost")then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " set power multi to " .. tostring(featurePowerMultiplier), "VEH", "VEHICLE")
	...
	elseif(action == "torqueboost")then
		...
		local plrname = GetPlayerName(PlayerId())
		TriggerServerEvent('mello:logToadmin', plrname .. " set torque multi to " .. tostring(featureTorqueMultiplier), "VEH", "VEHICLE")
