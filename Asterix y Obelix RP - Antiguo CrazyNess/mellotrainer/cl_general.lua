...
Citizen.CreateThread( function()
	while true do
		...
		if (IsControlJustReleased(0, 56) or IsDisabledControlJustReleased(0, 56)) and GetLastInputMethod(0) and not IsPauseMenuActive() and not blockinput and adminStatus == true then -- f1
		...
		if ( IsControlJustReleased( 0, 170 ) or IsDisabledControlJustReleased( 0, 170 ) ) and GetLastInputMethod( 0 ) and not blockinput and adminStatus == true then -- f3
			teleportToWaypoint()
		end

		if ( IsControlJustReleased( 0, 57 ) or IsDisabledControlJustReleased( 0, 57 ) ) and GetLastInputMethod( 0 ) and adminStatus == true then
			toggleNoClipMode()
		end
